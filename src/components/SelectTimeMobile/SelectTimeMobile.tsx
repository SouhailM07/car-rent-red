...
export default function SelectTimeMobile() {
  return (
    <>
      <article className="bg-white flex-col flex sticky top-[3rem] justify-between mx-auto max-w-[62rem] px-[1rem] py-[0.3rem]">
        <section className="flex flex-col items-center gap-y-[1rem] ">
          <SelectPlace />
          <SelectTimeOptions />
          <SelectHours />
        </section>
        <Button className="bg-primaryRed hover:bg-red-700 mt-[1rem]">
          SEARCH
        </Button>
      </article>
    </>
          ...
          <div className="flex space-x-[0.5rem]">
            ...
            <div>
              <button
                id="date"
                className={cn(
                  "w-[220px] justify-start text-center font-normal",
